...
def get_dependencies(repo: Repo, ref: str) -> Dict[str, Dict]:
    try:
        ...
        # Filter out packages (match pattern)
        filtered_package_patterns = [
            "*desktop_webview*",
        ...
        for package_name in list(packages.keys()):
            if any(
                ...
                for pattern in filtered_package_patterns
            ):
...
def main(repo_path: str, ref1: str, ref2: str, verbose: bool, skip_unchanged: bool):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        output_diff_file = os.path.abspath("dependency_code_diff.patch")
